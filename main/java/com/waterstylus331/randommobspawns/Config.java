...
public class Config
{
    ...
    private static final ForgeConfigSpec.BooleanValue BOGGED = BUILDER
            .comment("Enable/Disable Bogged spawning.")
            .define("boggedSpawning", true);
    ...
    public static boolean boggedEnabled;
